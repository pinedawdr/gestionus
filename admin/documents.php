...
if (!empty($filter)) {
    $sql .= " AND (d.original_name LIKE ? OR d.description LIKE ? OR u.name LIKE ?)";
    $searchTerm = "%{$filter}%";
    $params[] = $searchTerm;
    $params[] = $searchTerm;
    $params[] = $searchTerm;
...
<head>
    ...
    <title>Gestión de Documentos - GestiónUS</title>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            <a href="documents.php" class="border-b-2 border-white px-1 pt-1 text-sm font-medium">Documentos</a>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="user_id" id="user_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        ...
                                        <option value="<?php echo $userOption['id']; ?>" <?php echo $userId == $userOption['id'] ? 'selected' : ''; ?>>
